...
1.	Check that the **Upload** button is **red**.
...
1. Open the **imgweb*[yourname]* and **imgweb*[yourname]-stage* web apps in your browser. Check that **imgweb*[yourname]* has **red** "Upload" button and **imgweb*[yourname]-stage* has **gray** "Upload" button.

#### Review

In this exercise, you created a deployment slot, deploy a new version of frontend app and swap stage and production slots.

### Final Exercise: Clean up your subscription 
