...
1. In the "Basics" tab of the **Create Container Registry** page, fill out the following information:
    ...
    | **Resource group** section | Select **Create new**, enter **cProject-Sam-RG**, and then select **OK** |
    | **Registry name** section | enter **containerregistry**_[yourname]_** | 
...
1. Review your settings and select the **Create** to create the container registry.
...
1. Select **Deploy to Azure Container Instances** and fill out the following information:   
    ...
    | **Location** drop-down list | Select **East US** |
    | **Image** drop-down list | Select **DockerImage** |
    | **Registry** drop-down list | Select **containerregistry**_[yourname]_ |
    | **Operating system** section | Select **Linux** |
    | **Port** section | Select **80** |
    | **Size** section | Select **Standart** |
