...
1.  In the Azure portal, navigate back to the **Azure Cosmos DB** blade and, in the Cosmos DB accounts list, select the newly created **polycosmosDID** Azure Cosmos DB account.
...
1.  In the Azure portal's navigation pane, navigate back to the **Storage accounts** blade, and then select the **polystorDID** storage account that you created in this lab's previous exercise.
