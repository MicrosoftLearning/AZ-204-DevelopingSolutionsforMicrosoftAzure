...
1.  From the **SQL servers** blade, select **+ Create**.
...
1.  From the **Select API option** blade, select **Create** in the **Core (SQL) - Recommended** tile.
...
1.  From the **Azure Cosmos DB Deployment** blade, select **Go to Resource**.
