...
1.  On line 19, set the value of **JsonFilePath** by replacing the empty string with **"C:\\\AllFiles\\\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\\\Allfiles\\\Labs\\\04\\\Starter\\\AdventureWorks\\\AdventureWorks.Models\\\Models.json"**.

    >Note : Verify the JsonPath accordingly and also make the path contains two **\\**.
