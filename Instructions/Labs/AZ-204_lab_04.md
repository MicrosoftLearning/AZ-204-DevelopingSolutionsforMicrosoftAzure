...
1.  In the Azure portal, use the **Search resources, services, and docs** text box at the top of the page to search for **Azure Cosmos DB** and, in the list of results, select **Azure Cosmos DB**.

1.  From the **Azure Cosmos DB** blade, select **+ Create**.

1.  From the **Select API option** blade, select **Core (SQL) - Recommended**.

1.  From the **Basics** tab of the **Create Azure Cosmos DB Account - Core (SQL)** blade, perform the following actions:
    
    1.  Leave the **Subscription** list set to its default value.
    
    1.  In the **Resource group** section, select **Create new**, in the **Name** text box, type **PolyglotData**, and select **OK**.
    
    1.  In the **AccountName** text box, enter **polycosmos**_[yourname]_.
    
    1.  In the **Location** drop-down list, select an Azure region where you can create a Cosmos DB account and which is closest to the location of your lab computer.
    
    1.  In the **Capacity mode** section, select **Serverless**.
    
    1.  Select **Review + Create**.

1.  From the **Review + Create** tab of the **Create Azure Cosmos DB Account - Core (SQL)** blade, review the options that you selected during the previous steps.

1.  Select **Create** to create the Azure Cosmos DB account by using your specified configuration.

    > **Note**: Wait for the creation task to complete before you move forward with this lab.

1.  In the Azure portal, navigate back to the **Azure Cosmos DB** blade and, in the listing of Cosmos DB accounts, select the newly created **polycosmos**_[yourname]_ Azure Cosmos DB account.
