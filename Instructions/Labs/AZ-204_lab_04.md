...
1.  In the Azure portal, navigate back to the **Azure Cosmos DB** blade and, in the listing of Cosmos DB accounts, select the newly created **polycosmos***[yourname]* Azure Cosmos DB account.
...
1.  In the Azure portal's navigation pane, navigate back to the **Storage accounts** blade and select the **polystor***[yourname]* storage account that you created in the previous exercise of this lab.

1.  From the **polystor***[yourname]* storage account blade, select the **Containers** link in the **Data storage** section.
...
1.  In the Azure portal, navigate back to the **Azure Cosmos DB** blade and, in the listing of Cosmos DB accounts, select the **polycosmos***[yourname]* Azure Cosmos DB account that you created earlier in this lab.
