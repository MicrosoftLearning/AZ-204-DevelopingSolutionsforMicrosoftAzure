...
1.  On the **Basics** tab of the **Create Azure Cosmos DB Account - Core (SQL)** blade, perform the following actions, and then select **Review + Create**:
    ...
    :::image type="content" source="../media/l04-cosmosdb-create-summary.png" alt-text="Screenshot displaying the options configured for creating an Azure Cosmos DB account." border="false":::
    
    ![Screenshot displaying the options configured for creating an Azure Cosmos DB account](../media/l04-cosmosdb-create-summary.png)
...
1.  On the **Basics** tab of the **Create a storage account** blade, perform the following actions, and then select **Review + Create**:
    ...
    | **Redundancy** drop-down list | Select **Locally-redundant storage (LRS)**. |
     ...
     :::image type="content" source="../media/l04_storage_create_summary.png" alt-text="Screenshot displaying the options configured for creating a storage account." border="false":::
...
In this exercise, you created the Azure resources that you'll need for the polyglot data solution you will implement in this lab, including an Azure Cosmos DB account and an Azure Storage account.
...
1.  Note the invocation of the **DefineContainer** method of the **Database** class. This will create a container that will host the JSON items, if one does not already exist.
    ...
    > **Note**: The **DefineContainer** method includes the option to modify the default indexing policy (which automatically indexes all attributes) to minimize cost.
