...
1.  On the **polystor<inject key="DeploymentID" enableCopy="false"/>** storage account blade, select the **Containers** link in the **Data storage** section.
...
1.  In the **Upload blob** pop-up, perform the following actions:
    ...
    a.  In the **Files** section, select the **Browse for files**.
