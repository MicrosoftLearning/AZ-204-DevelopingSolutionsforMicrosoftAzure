...
1. On the **Create Topic** blade, on the **Basics** tab, perform the following actions, and then select **Next: Advanced**:
    ...
    | **Resource group** drop-down list | Select **Existing**, enter **PubSubEventsDID**, and then select **OK**.|
    | **Name** text box                 | Enter **hrtopicDeploymentID**.                                         |
...
1. On the **Create Web App** blade, on the **Basics** tab, perform the following actions, and then select **Next: Docker**:
   ...
   | **Name** text box                 | Enter **eventviewerDeploymentID**.                                                            |
...
1. In the **File Explorer** window that opens, browse to **Allfiles (C):\\Allfiles\\Labs\\09\\Starter\\EventPublisher**, and then select **Select Folder**.
