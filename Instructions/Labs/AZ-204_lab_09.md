...
1. From the **Marketplace** search results blade, select the **Event Grid Topic** result.

1. From the **Event Grid Topic** blade, select **Create**.

1. From the **Create Topic** blade, perform the following actions:
    ...
    1. From the **Region** drop-down list, select the **(US) East US** region.
...
1. From the **Create Web App** blade, find the tabs on the blade, such as **Basics**.
