...
1. Run the following command to import version 4.10.0 of **Azure.Messaging.EventGrid** from NuGet:
    ...
    > **Note**: The **dotnet add package** command will add the **Azure.Messaging.EventGrid** package from NuGet. For more information, go to [Azure.Messaging.EventGrid](https://www.nuget.org/packages/Azure.Messaging.EventGrid/4.10.0).
