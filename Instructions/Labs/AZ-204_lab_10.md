...
1.  Review the **Program.cs** file, which should now include the following code. Note that the `<storage-connection-string>` placeholder represents the connection string to the target Azure Service Bus namespace: <!--ID/SME, please review the edits to this step.-->
