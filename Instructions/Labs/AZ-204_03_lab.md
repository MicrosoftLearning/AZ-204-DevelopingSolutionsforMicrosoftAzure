...
1.  Record the value in the **Blob Service** text box. You'll use this endpoint value later in this lab.
...
1.  Select the **Containers** link in the **Data storage** section, and then select the newly created **vector-graphics** container.
