...
1.  In the **Blob service** section record the value in the **Blob service** textbox. (https://yourStorageAccount.blob.core.windows.net/) You'll use this value later in this lab.
...
1.  Using a Visual Studio Code (Command Prompt) terminal, create a new .NET project named **BlobManager** in the current folder:
...
1.  Select the **Containers** link in the **Blob service** section, and then select the newly created **vector-graphics** container. If the new container is not displayed, click **Refresh**.
