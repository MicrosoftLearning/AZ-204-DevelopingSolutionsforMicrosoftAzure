...
1.  In the Azure portal's navigation pane, use the **Search resources, services, and docs** text box to search for **Resource group** and then, in the list of results, select **Resource groups**.
