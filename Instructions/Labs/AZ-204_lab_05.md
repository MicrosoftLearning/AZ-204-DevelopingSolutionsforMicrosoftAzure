...
1.  In the Azure portal's navigation pane, select the **Create a resource** link.
 <!--Conan, should this be updated to match Marcin;s labs as follows: In the Azure portal, use the **Search resources, services, and docs** text box to search for **Create a resource**, and then in the list of results, select **Create a resource**. Or is your original instruction the correct one?-->
