...
1.  On the **ContainerCompute-<inject key="DeploymentID" enableCopy="false"/>** blade, select the container registry that you created previously in this lab, and then select **Properties** (1).    

1.  On the **Properties** blade, in the **Admin user** section, select **Enable** (2).

    ![](./media/az-204-m7.png)

1.  Select **Save**, and then close the **Properties** blade.
