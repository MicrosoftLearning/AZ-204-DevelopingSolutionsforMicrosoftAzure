...
Before starting this lab, you must complete **Pre-requisites** of this lab.
...
2. Select the **Extensions** blade from left pannel.
3. Search with **C#** and select **Install** to install the extension.

    ![](./media/vsds.png)

4. After installing C# extensions, close the Visula studio code.
