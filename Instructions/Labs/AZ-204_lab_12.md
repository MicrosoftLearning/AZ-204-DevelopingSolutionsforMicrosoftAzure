...
1. In the Azure portal, use the Search resources, services, and docs text box to search for **CDN** and then, in the list of results, select **FRONT DOOR CDN PROFILE**.
