...
1.  At the **Cloud Shell** command prompt in the portal, perform the following actions:
    ...
    1.  Enter the following command, and then select Enter to register the **Microsoft.CDN** namespace with your current subscription:
        ...
        ```
     > **Note**: It may take some time to register the provider. If warnings are experienced when trying to create the CDN, log out/in  the Azure portal.
...
1.  In the **Configuration** section, perform the following actions:
    ...
    1.  Select **Continue** to confirm your changes.
...
1.  On the **App Service** blade, select **Restart**.

1.  Select **Yes** to confirm the app restart process.
...
1.  In the **Overview** section, select **Restart**.
