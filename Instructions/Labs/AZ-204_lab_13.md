...
1. Copy the vules of **CNAME** and **TXT** DNS records, from the **Domain validation** section.

1. Go to your domain DNS provider and create a **CNAME** and **TXT** records with the vlues that you copied from the **Domain validation** section.
