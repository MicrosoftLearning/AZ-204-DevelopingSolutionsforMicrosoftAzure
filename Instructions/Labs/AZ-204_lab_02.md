...
<!--ID/SME: Azure Functions is correct according to Term Studio. The exercise title is correct, even if it's singular. The term "function app" is lowercase, except when the UI displays otherwise. -->
...
1. When you receive the open command prompt, run the following command to run the function app project:
    ...
    func start --build
    ```
<!--ID/SME: Please check how this note displays.-->
    > **Note**: You can review the documentation to [start the function app project locally][azure-functions-core-tools-start-function] using the **Azure Functions Core Tools**.
