...
1. Close all currently running instances of the **Windows Terminal** application, and the **Command Prompt** application.
...
1. Close all currently running instances of the **Windows Terminal** application, and the **Command Pormpt** application.
