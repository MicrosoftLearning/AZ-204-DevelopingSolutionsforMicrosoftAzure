...
1. Return to the currently open **Terminal** window. Wait for the sign-in process to finish.
    ...
    > **Note**: Before proceeding to the following step, if you have a file called **func.sln** displayed in the VS Code explorer pane, ensure you **delete** this file from your project.
