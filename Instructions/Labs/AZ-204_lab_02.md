...
# Lab 02: Implementing task processing logic by using Azure Functions
...
1. In the **Cloud Shell** pane, run the following command to delete the **Serverless** resource group:
