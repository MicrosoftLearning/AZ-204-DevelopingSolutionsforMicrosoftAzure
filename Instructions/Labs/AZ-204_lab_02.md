...
1. On the taskbar, Search **Command Prompt** on the icon Right-click and Run as administrator.
...
1. In the **File Explorer** window that opens, browse to **C:\AllFiles\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\Allfiles\Labs\02\Starter**, and then select **Select Folder**.
...
1. Select **Save** to save your changes to the **GetSettingInfo.cs** file.
   ...
   > **Note**: If you see an error ("Type or Namespace Blobattribute not found)
