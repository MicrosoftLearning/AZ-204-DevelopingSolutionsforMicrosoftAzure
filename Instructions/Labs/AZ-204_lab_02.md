...
1. On the **Hosting** tab, perform the following actions, and then select **Review + create**:    
    ...
    ![Create Function App blade on Hosting tab](./media/l02_create_a_function_app_hosting_tab.png)
...
In this exercise, you created created all the resources that you'll use for this lab.
