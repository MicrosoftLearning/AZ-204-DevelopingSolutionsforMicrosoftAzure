...
1. On the **All services** blade, select **Storage Accounts**, and then review the list of storage account instances.
...
1. On the **Basics** tab, perform the following actions, and then select **Review + create**:
    ...
    ![Create a storage account blade](./Media/l02_create_a_storage_account.png)
...
1. On the **Create a resource** blade, in the **Search services and marketplace** text box, enter **Function**, and then press Enter.

1. On the **Marketplace** search results blade, select the **Function App** result.

1. On the **Function App** blade, select **Create**.

1. On the **Create Function App** blade, review the tabs from the blade, such as **Basics**, **Hosting**, **Monitoring**, **Tags**, and **Review + create**.
...
1. On the **Basics** tab, perform the following actions, and then select **Next: Hosting**:
    ...
    ![Create Function App blade](./Media/l02_create_a_function_app.png)
...
The following screenshot displays the configured settings on the **Hosting** tab on the **Create Function App** blade.
    ...
    ![The Hosting tab on the Create Function App blade ](./Media/l02_create_a_function_app_hosting_tab.png)
...
<!--Conan, can you please confirm the casing of Functions and also if it should be singular or plural? The task heading has it lower case and singular and since we are saying "a local", it should be singular in the exercise title too unless the UI has it otherwise.-->
...
1. Enter the following command, and then select Enter to use the **Azure Functions Core Tools** to create a new local Azure Functions project in the current directory using the **dotnet** runtime:
...
1. Enter the following command, and then select Enter to use the **Azure Functions Core Tools** to create a new function named **Echo** using the **HTTP trigger** template:
...
1. Enter the following command, and then select Enter to run the function app project:
...
1. On the taskbar, select the **Windows Terminal** icon again to open a new instance of the napplication.
...
1. On the **Resource groups** blade, select the **Serverless** resource group that you created earlier in this lab.
...
1. Enter the following command, and then select Enter to build the .NET project and to validate the extensions were installed correctly:
...
<!--Conan, I need to check if we can include a summary of the links here again-->
