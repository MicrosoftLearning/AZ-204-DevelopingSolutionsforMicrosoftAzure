...
1. Review any one of the keys, and then copy the value of either of the **Key** boxes to the clipboard.
     ...
     > **Note**: It doesn't matter which Key you choose. They are interchangeable.

1. Open Notepad, and then paste the copied key value to Notepad.
...
1.  In ther terminal, run the following command to import version 12.0.0 of **Azure.Storage.Blobs** from NuGet:
