...
3.  On the **Create a storage account** blade, on the **Basics** tab, perform the following actions, and then select **Review**:
        ...
        | **Resource group** section        | Select **StorageMedia-[Deploymentid]**. |
...
7.  On the **Storage account** blade, in the **Settings** section, select the **Endpoints** link.

8.  In the **Endpoints** section, copy the value of the **Blob Service** text box to the clipboard.

       > **Note**: You'll use this endpoint value later in the lab.

9.  On the **Storage account** blade, in the **Security + networking** section, select the **Access keys** link.

10.  In the **Access keys** section, perform the following actions:
