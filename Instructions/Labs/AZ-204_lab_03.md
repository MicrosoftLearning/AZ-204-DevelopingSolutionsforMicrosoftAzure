...
1.  On the **File** menu, select **Open Folder**, browse to **Windows (C):\AllFiles\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\Labs\\03\Starter\\BlobManager**, and then select **Select Folder**.
...
1.	In the **Upload blob** window, perform the following actions, and then select **Upload**:
    ...
    | --------------------------------- | ------------------------------------------------------------ |
    | **Files** section   | Select the **Folder** icon. |
    | **File Explorer** window        |  **Windows (C):\AllFiles\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\Labs\03\\Starter\\Images**, select the **graph.svg** file, and then select **Open**. |
    | **Overwrite if files already exist** check box | Ensure that the check box is selected. |
