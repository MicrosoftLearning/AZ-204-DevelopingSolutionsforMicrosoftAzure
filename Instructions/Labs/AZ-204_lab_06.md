...
1.  In the **Overview** section, find and record the value of the **Application (client) ID** text box. Record the Application (client) ID you'll use this value later in the lab.

1.  In the **Overview** section, find and record the value of the **Directory (tenant) ID** text box. Record the Directory (tenant) ID you'll use this value later in the lab.
...
1.  Add or update below lines under **ItemGroup** section
...
1.  On the **Portal settings | Directories + subscriptions** blade, if not selected by default then select **Switch** next to the entry representing the Azure AD tenant associated with your subscription(do not switch to contoso).
...
1.  On the **Portal settings | Directories + subscriptions** blade, select **Switch** next to the entry representing the Azure AD tenant associated with your subscription(do not switch to contoso).
