...
1.  Run the following command to identify the user principal name (UPN) of the newly created Azure AD user:
    ...
    > **Note**: If there is no UPN printed from executing the command above. You can, however, retrieve the UPN by using the Azure portal, go to Azure Active Directory, select Users blade
    > ![image](https://user-images.githubusercontent.com/98095529/176684849-809d7482-8dc2-4694-a6d0-21e7c7108d74.png)
    > 
    > Search for the userid mentioned in step 5 and copy the UPN as highlighted.
