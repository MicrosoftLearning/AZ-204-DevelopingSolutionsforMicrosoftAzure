...
1.  Review the **Welcome** home page of the target site displayed by the browser and verify that the UPN of the **aad_user1** Azure AD account appears at the top of the browser window.
...
1.  Review the **Welcome** home page of the target site that the browser displays, and then verify that the UPN of the **aad_lab_user1** Azure AD account appears at the top of the browser window.
...
1.  Review the **Welcome** home page of the target site that the browser displays, and then verify that the UPN of the **aad_lab_user2** Azure AD account appears at the top of the browser window.
