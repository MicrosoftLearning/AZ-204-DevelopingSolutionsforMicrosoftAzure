...
1.  On the **Docker** tab, perform the following actions, and then select **Review + create**:
    ...
    The following screenshot displays the **Review + create** tab indicating the settings configured on the **Docker** tab.
...
1.  In the **Cloud Shell** pane, run the following command to delete the **ApiService** resource group:
