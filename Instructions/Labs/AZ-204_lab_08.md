...
1.  On the **Review + Create** tab, review the option that you specified in the previous steps.
...
1.  From the **API Management Deployment** blade, select **Go to resource**.

1.  From the **API Management Service** blade, in the **APIs** section, select **APIs** .
