...
1.  Within the web application, perform the following actions:
    ...
    g.  Select **Download file**, and after the file is downloaded, open it in Notepad, review its content, and close it.
...
1.  Within the web application, perform the following actions:
    ...
    g.  When prompted, in the **Username** text box, enter **user**, in the **Password** text box, enter **passwd**, and select **Sign in**. 
...
1.  Switch back to the browser window displaying the **httpapi**_[yourname]_ web app.
