...
1.  Within the web application, perform the following actions:
    ...
    1.  In the **n** text box, enter **25**.

    1.  Select **Execute**.

    1.  Review the value of the **Response body** and **Response headers** text boxes.

    1.  Select **Download file**, and after the file downloads, open it in Notepad, review its content, and then close it.
...
1.  Within the web application, perform the following actions:
    ...
    1.  Select **Status codes**.

    1.  Select **GET /status/{codes}**.

    1.  Select **Try it out**.

    1.  In the **codes** text box, enter **404**.

    1.  Select **Execute**.

    1.  Review the **Server response** and note that it includes **Error: NOT FOUND** entry.
