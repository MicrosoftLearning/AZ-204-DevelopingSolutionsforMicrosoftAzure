...
Given the dynamic nature of Microsoft cloud tools, you might experience Azure user interface (UI) changes that occur after this training content's development. These changes might cause the lab instructions and steps to not align correctly.
...
<!--ID/SME: Please check indent in the following note.-->
> **Note**: If this is your first time signing in to the Azure portal, you'll be offered a tour of the portal. Select **Get Started** to skip the tour and begin using the portal.

#### Task 2: Create an Application Insights resource

1.  In the Azure portal, use the **Search resources, services, and docs** text box at the top of the page to search for **Application Insights**. In the list of results, select **Application Insights**.
...
<!--ID/SME: Global comment. Please check the capitalization of "web API" across all units. When referring to the service, Azure Web API is appropriate.-->
#### Task 3: Create an Azure web API resource

1.  In the Azure portal, use the **Search resources, services, and docs** text box at the top of the page to search for **App Services**. In the list of results, select **App Services**.
...
1.  Select **Create** to create the web API by using your specified configuration.
    ...
    > **Note**: Wait for the creation task to complete before you proceed with this lab.
<!--ID/SME: Please check the use of api throughout this file. If api is correctly used, please capitalize all instances.-->
