...
1.  In the browser window, navigate to the Azure web api app into which you deployed the API app earlier in this task by appending to its URL you recorded earlier in this lab the suffix **/weatherforecast**.
...
1.  On your lab computer, from the taskbar, open the context menu for the **Microsoft Edge** icon, and then open a new browser window.
    ...
    > **Note**: Position the browser window such that it does not block the Visual Studio Code terminal pane.
