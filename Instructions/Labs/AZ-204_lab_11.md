...
1. On the **Create Web App** blade, on the **Basics** tab, perform the following actions, and then select the **Monitoring** tab:
    ...
    | **Runtime stack** drop-down list | Select **.NET 8 (LTS) (Early Access)** |
...
1. In the **Visual Studio Code** window, in the **Explorer** pane, navigate to the **bin\Debug\net8.0** directory.
    ...
    > **Note**: To verify that you are in the **bin\Debug\net8.0** directory, in Visual Studio Code, on the File menu, select Open Folder and browse to **Allfiles (F):\\Allfiles\\Labs\\11\\Starter\\Api\\bin\\Debug\\net8.0**, and then select **Select Folder**.
