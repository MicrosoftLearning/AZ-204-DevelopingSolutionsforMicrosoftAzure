...
3. On the **Log Analytics workspaces** blade, on the **Basics** tab, perform the following actions, and select **Review + Create**:
      ...
      | **Resource group** section      | Select **Existing**, enter **MonitoredAssets-{DeploymentID}**, and then select **OK**. |
      | **Name** text box               | **Analyticsworkspace{DeploymentID}**.                           |
...
1.  On the **Application Insights** blade, on the **Basics** tab, perform the following actions, and select **Review + Create**:
    ...
    | **Subscription** drop-down list | Retain the default value.                                    |
    | **Resource group** section      | Select **Existing**, enter **MonitoredAssets-{DeploymentID}**, and then select **OK**. |
    | **Name** text box     | **instrm{DeploymentID}**.                           |
...
1.  On the **Create Web App** blade, on the **Basics** tab, perform the following actions, and then select **Next: Deployment**:
    ...
    | **Name** text box     | Enter **smpapi{DeploymentID}**.                           |
...
1.  On the **Monitoring** tab, perform the following actions, and then select **Review + Create**:
    ...
    | **Application Insights** drop-down list     | Select the **instrm{DeploymentID}** Application Insights resource that you created previously in this lab.|
