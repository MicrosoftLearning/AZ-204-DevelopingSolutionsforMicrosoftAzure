...
1.  In the browser window, browse to the Azure portal ([portal.azure.com](https://portal.azure.com)) and sign in with the account you will be using for this lab.
...
1.  On the **Monitoring** tab, perform the following actions:
    ...
    1.  In the **Application Insights** drop-down list, select the **(New) instrm***[yourname]* Application Insights resource that you created earlier in this lab.
...
1.  In the Azure portal, navigate back to the blade of the **instrm***[yourname]* Application Insights resource you created earlier in this lab.
...
1.  Run the following command to create a zip file containing the starter project that you will deploy next to the Azure web api:
...
1.  In the Azure portal, navigate back to the blade of the **smpapi***[yourname]* web app resource you created earlier in this lab.
