...
1. First we will enable Public access for the Storage Account, on the **Storage Account** blade, naviage to the **Settings** section and click **Configuration**.

1. Under the setting titled **Allow Blob public access**, click **Enable**.

1. Click **Save** at the top of the page. Thenn wait a minute or two for the setting to propagate.
