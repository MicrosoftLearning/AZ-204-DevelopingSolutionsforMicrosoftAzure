...
1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions, and then select **Review + create**:
    ...
    | **Resource group** section      | Select **use existing, enter ManagedPlatform-[deployId], and then select OK.** |
    | **Storage account name** text box | Enter  **imgstor[deployId]**_.             |
...
1. On the **Create Web App** blade, on the **Basics** tab, perform the following actions, and then select **Next: Deployment**:
    ...
    | **Name** text box | Enter **imgapi[deployId]**_. |
...
1. On the **ManagedPlatform** blade, select the **imgapi[deployId]_ web app that you created previously in this lab.
...
1. On the **ManagedPlatform-[deployId]** blade, select the **imgweb[deployId]_ web app that you created previously in this lab.
