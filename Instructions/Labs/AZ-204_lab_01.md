...
# Lab 01: Building a web application on Azure platform as a service offering
...
![Architecture diagram that Building a web application on Azure platform as a service offering.](./Media/l01_diagram.png)
...
1.  On the **ManagedPlatform** blade, select the **imgapi**_[yourname]_ web app that you created earlier in this lab.
    ...
    > **Note**: If the **imgapi**_[yourname]_ web app isn't listed, select the **Show hidden types** check box to display it.
...
1.  On the **ManagedPlatform** blade, select the **imgweb**_yourname_ web app that you created earlier in this lab.
    ...
    > **Note**: If the **imgweb**_yourname_ web app isn't listed, select the **Show hidden types** check box to display it.
...
The following screenshot displays the **Cloud Shell** icon.

![Cloud Shell icon](./Media/az204_lab_CloudShell.png)
...
1.  From the **Cloud Shell** pane, run the following command to delete the **ManagedPlatform** resource group:
