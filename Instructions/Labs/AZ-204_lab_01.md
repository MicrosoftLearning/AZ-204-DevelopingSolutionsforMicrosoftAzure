...
1. To view more information about App Services, select the **Properties** link on the **App Service** blade in the **Settings** section.

1. To get the App Service's URL, go to the **Overview** blade, copy the value from the **URL** section, and then paste it to Notepad. You’ll use this value later in the lab.
