...
1.  From the **Storage accounts** blade, select **New** (or **Create** or **Add**, depends on your UI).
...
1.	From the **Access keys** blade, select any one of the keys, and then record the value of either of the **Connection string** boxes. You'll use this value later in this lab.
    ...
    > **Note**: Click on **Show Keys** button on top of the view to enable the copy feature on Keys and ConnectionStrings.
