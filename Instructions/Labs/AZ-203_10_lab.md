...
1.  Review the list of currently registered providers. Note that the **Microsoft.EventGrid** provider isn't currently in the list of providers.
...
1.  Create a new **Event Subscription** with the following details:
    ...
    -   Endpoint: ***Web App URL recorded earlier in the lab*/api/updates**

        > **Note**: For example, if your **Web App URL** value is **https://eventviewerstudent.azurewebsites.net/**, then your endpoint would be **https://eventviewerstudent.azurewebsites.net/api/updates**.
...
1.  Using the same terminal, import version 28.4.4 of **Bogus** from NuGet:
...
1.  In the **Main** method, perform the following actions:
    ...
    1.  Add the following block of code to: create two new variables named **firstPerson** of type **Person**, and **firstEvent** of type **EventGridEvent**; populate the **EventGridEvent** variable with sample data; and add the **firstEvent** instance to your **events** list:
    ...
    1.  Add the following block of code to: create two new variables named **secondPerson** of type **Person**, and **secondEvent** of type **EventGridEvent**; populate the **EventGridEvent** variable with sample data; and add the **secondEvent** instance to your **events** list:
