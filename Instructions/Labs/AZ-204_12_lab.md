...
1.  Select the **Containers** link in the **Data storage** section, and then select the **media** container.

1.  Upload the following files from the **Allfiles (F): \\Allfiles\\Labs\\12\\Starter** folder on your lab VM:
...
1.  Upload the **welcome.mp4** file from the **Allfiles (F): \\Allfiles\\Labs\\12\\Starter** folder on your lab VM.
