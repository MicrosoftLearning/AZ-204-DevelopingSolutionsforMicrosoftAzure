...
1.  Use the **az provider show --namespace microsoft.cdn --query "[namespace,registrationState]"** command to retrieve the registration status for **Microsoft.Cdn** provider.

1.  If the value of **registrationState** is **NotRegistered**, use the **az provider register --namespace Microsoft.Cdn** command to register the provider.
