...
1. Append an attribute to the **Run** method of type **FunctionName** that has its **name** parameter set to a value of **Echo**:
...
1. Append an attribute to the **Run** method of type **FunctionName** that has its **name** parameter set to a value of **GetSettingInfo**:
...
1. Publish the function app project.
    > **Note**: You can review the documentation to [publish the local function app project][azure-functions-core-tools-publish-azure] using the **Azure Functions Core Tools**.
