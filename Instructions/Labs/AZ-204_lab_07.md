...
<!--ID/SME: Should "0 selected" be changed to "None selected" in the above instances?"-->
    The following screenshot displays the configured settings in the **Add access policy** blade.
<!--ID/SME: Please check the formatting syntax above and below.-->
...
<!--ID/SME: Please check the capitalization in the above "save Changes" instance.-->
...
1. Run the following command to use the **Azure Functions Core Tools** to create a new local Functions project in the current directory using the **dotnet** runtime:
    ...
    ```
<!--ID/SME: Please review the syntax for the following to make sure it displays correctly.-->
