...
1. On the Azure portal's navigation pane, select **Azure Services**.

1. On the **Azure Services** blade, select **Storage accounts**.
...
1. Run the following command to update the sdk version:

     ```powershell
    dotnet new globaljson --sdk-version 3.1.414 --force
    ```
