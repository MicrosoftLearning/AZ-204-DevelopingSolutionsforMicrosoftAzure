...
1. From the **Basics** tab, perform the following actions:
   ...
   b. In the **Resource group** section, select **Create new**, enter **ConfidentialStack**, and then select **OK**.
   ...
   f. In the **Redundancy** drop-down list, select **Locally-redundant storage (LRS)**.
...
1. From the **Access keys** blade, select **Show keys**.
...
1. From the **Basics** tab, perform the following actions:
   ...
   b. In the **Resource group** section, select **Use existing**, and then select **ConfidentialStack** in the list.
...
1. From the **Basics** tab, perform the following actions:
   ...
   e. In the **Runtime stack** drop-down list, select **.NET**.
   
   f. In the **Version** drop-down list, select **3.1**.
   
   g. In the **Region** drop-down list, select the **East US** region.
   
   h. Select **Next: Hosting**.

2. From the **Hosting** tab, perform the following actions:
   
   a. In the **Storage account** drop-down list, select the **securestor[yourname]** storage account that you created earlier in this lab.
   
   b. In the **Operating System** section, select **Linux**.
   
   c. In the **Plan type** drop-down list, select the **Consumption (Serverless)** option.
...
1. From the **Add access policy** blade, perform the following actions:
   ...
   b. From the **Principal** blade, find and then select the service principal named **securefunc[yourname]**, and then select **Select**.
...
1. From the **Configuration** pane, perform the following actions:
   ...
   b. In the **Add/Edit application setting** pop-up window, in the **Name** text box, enter **StorageConnectionString**.
   
   c. In the **Value** text box, construct a value by using the following syntax: ``@Microsoft.KeyVault(SecretUri=*Secret Identifier*)``
   ...
   d. Leave the **deployment slot setting** text box set to its default value.
   
   e. Select **OK** to close the pop-up window and return to the **Configuration** section.
   
   f. Select **Save** from the blade to save your settings.  
   
   g. In the **Save Changes** confirmation pop-up dialog box, select **Continue**.
...
1. In the **New container** pop-up window, perform the following actions:
   ...
   b. In the **Public access level** drop-down list, select **Blob (anonymous read access for blobs only)**, and then select **Create**.
...
1. In the **Upload blob** pop-up window, perform the following actions:
   ...
   b. In the **File Explorer** window, browse to **Allfiles (F):\\Allfiles\\Labs\\07\\Starter**, select the **records.json** file, and then select **Open**.
...
1. If this is your first time opening Cloud Shell using your subscription, you can use the **Welcome to Azure Cloud Shell Wizard** to configure Cloud Shell for first-time usage. Perform the following actions in the wizard:
    ...
    a. A dialog box prompts you to configure the shell. Select **Bash**, review the selected subscription, and then select **Create storage**.
