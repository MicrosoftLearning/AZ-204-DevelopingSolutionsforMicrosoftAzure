...
1. Navigate to the **Access Configuration** tab and change the permission model to **Vault access policy**.
...
1. On the **Create Function App** blade, on the **Basics** tab, perform the following actions, and then select **Next: Storage**:
   ...
   | **Version** drop-down list        | Select **8 (LTS) Isolated (Early Access)** |
...
1. Replace the content of the auto-generated code of the function **FileParser** starting with line 19 with the following code:
