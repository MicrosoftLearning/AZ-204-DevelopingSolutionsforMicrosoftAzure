...
1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions, and select **Review**:
   ...
   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/az-204_09-createstrgacc.png)
...
3.  On the **Create key vault** blade, on the **Basics** tab, perform the following actions, and then select **Review + create**:
   ...
   ![Screenshot displaying the configured settings on the Create key vault blade](./media/az-204_09-createKeyVault.png)
