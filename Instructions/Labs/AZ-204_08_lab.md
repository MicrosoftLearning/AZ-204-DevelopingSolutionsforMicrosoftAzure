...
1.  In the Azure portal, create a new API Management service with the following details:
...
1.  Access the **prodapi*[yourname]*** API Management service that you created earlier in this lab.
