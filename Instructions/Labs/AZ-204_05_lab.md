...
1.  Right-click the **latest** tag or activate the shortcut menu for the **ipcheck** container image to deploy a new Azure container instance (select "Run Instance" in the right-click menu) with the following settings:
